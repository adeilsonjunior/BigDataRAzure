...
# Pergunta de Negócio do Lab 2: Qual o número provável de usuários convertidos? (Regressão)
# Pergunta de Negócio do Lab 3: Um Lead será convertido? Sim ou Não? Qual a probabilidade? (Classificação)
